    ...
    <x-slot name="header">
        <div class="flex items-center">
            <a href="{{ route('books.index') }}" class="mr-2 text-gray-500 hover:text-gray-700">
                <svg xmlns="http://www.w3  }}" class="mr-2 text-gray-500 hover:text-gray-700">
                ...
                <div class="p-6">
                    <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Upload a JPEG, PNG, or GIF image (max 2MB).</p>
                                    @error('cover_image')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('books.index') }}" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md transition-colors">
                                Cancel
                            </a>
